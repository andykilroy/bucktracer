...
fn normal_for_triangle() {
    ...
    let n1 = t.normal_at(point( 0.0, 0.5, 0.0), &intersection(0.0, &t));
    let n2 = t.normal_at(point(-0.5, 0.75, 0.0), &intersection(0.0, &t));
    let n3 = t.normal_at(point( 0.5, 0.25, 0.0), &intersection(0.0, &t));
