...
fn what_is_the_normal_on_a_sphere_on_x_axis() {
    let s = unit_sphere();
    let n = s.normal_at(point(1.0, 0.0, 0.0), &intersection(0.0, &s));
...
fn what_is_the_normal_on_a_sphere_on_y_axis() {
    let s = unit_sphere();
    let n = s.normal_at(point(0.0, 1.0, 0.0), &intersection(0.0, &s));
...
fn what_is_the_normal_on_a_sphere_on_z_axis() {
    let s = unit_sphere();
    let n = s.normal_at(point(0.0, 0.0, 1.0), &intersection(0.0, &s));
...
fn normal_on_non_axial_point() {
    ...
    let s = unit_sphere();
    let n = s.normal_at(point(sqrt3by3, sqrt3by3, sqrt3by3), &intersection(0.0, &s));
...
fn normal_on_translated_sphere() {
    ...
    let n = s.normal_at(point(0.0, 1.70711, -0.70711), &intersection(0.0, &s));
...
fn normal_on_transformed_sphere() {
    ...
    let n = s.normal_at(point(0.0, rt2by2, -rt2by2), &intersection(0.0, &s));
