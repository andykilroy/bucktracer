...
fn normal_of_untransformed_plane___is_up() {
    ...
    let n1 = p.normal_at(point(0.0, 0.0, 0.0), &intersection(0.0, &p));
    let n2 = p.normal_at(point(10.0, 0.0, -10.0), &intersection(0.0, &p));
    let n3 = p.normal_at(point(-5.0, 0.0, 150.0), &intersection(0.0, &p));
